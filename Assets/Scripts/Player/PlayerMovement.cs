...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            anim.SetBool("walkWithShotgun", Mathf.Abs(horizontalInput) > 0.01f);
            anim.SetBool("run", false);
        }
        else
        {
            ...
            anim.SetBool("walkWithShotgun", false);
        }
